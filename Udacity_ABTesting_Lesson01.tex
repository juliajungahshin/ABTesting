...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item margin of error m = $zscore * SE$ = $z* \sqrt{\frac{\hat{p}(1-\hat{p})}{N}}$ \\
    ...
    \begin{itemize}
        ...
        Difference $\hat{d} = \hat{p_{exp} - \hat{p_{cont}}}$
    ...
    \begin{itemize} 
        ...
        \item Power has an inverse trade-off with size: The smaller the change that you want to detect or the increased confidence you want to have in the result, means larger experiment required, so more page views in control and experiment
    \end{itemize}
    \end{shaded}
\end{itemize}
